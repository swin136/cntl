...
AFTER_REBOOT_MSG = '\U00002705 ' + 'Бот на устройстве <b><I><u>Бегемотик</u></I></b> запущен.' 
STOP_BOT_MSG = '\U0001F198 ' + 'Бот на устройстве <b><I><u>Бегемотик</u></I></b> остановлен.' 
...
TEST_NETWORK_HOSTS = {
    ...
    'lombard-alania.ru' : 'Сервер SSH-туннелей устройства',
